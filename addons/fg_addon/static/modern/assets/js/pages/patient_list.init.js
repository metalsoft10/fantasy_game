...
if($('.medical_patient_list').length > 0){
        ...
        function loadTeamData(e) {
            ...
            $(e).each(function(t, r) {
                ...
                if(r.coverImg == ""){
                    branche_cover = "/fg_addon/static/modern/assets/images/users/patient_cover.png"
                }
            ...
            $(".team-box").each(function() {
                $(this).find(".member-name").on("click", function() {
                    var e = $(this).find("h5").html(),
                        ...
                        r = $(this).closest(".team-box").find(".member-img").length ? $(this).closest(".team-box").find(".member-img").attr("src") : "/fg_addon/static/modern/assets/images/users/user-dummy-img.jpg",
