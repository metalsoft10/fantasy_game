...
!function() {
    var r = "/fg_addon/static/modern/assets/images/users/user-dummy-img.jpg"
      , n = "/fg_addon/static/modern/assets/images/users/multi-user.jpg"
      , o = !1;
    function s() {
    ...
    var a = "users-chat"
      , c = "users"
      , l = "/fg_addon/static/modern/assets/json/"
      , d = ""
      , m = 1;
    v(a);
    ...
    function t(e) {
        ...
        t = function(e, t) {
            ...
            a.forEach(function(t, e) {
                ...
                m != t.from_id && (n += '<div class="chat-avatar"><img src="/fg_addon/static/modern/' + s.profile + '" alt=""></div>'),
    ...
    e("chat-users-list.json", function(e, t) {
        null !== e ? console.log("Something went wrong: " + e) : (t[0].users.forEach(function(e, t) {
            var s = e.profile ? '<img src="/fg_addon/static/modern/' + e.profile + '" class="rounded-circle img-fluid userprofile" alt=""><span class="user-status"></span>' : '<div class="avatar-title rounded-circle bg-primary text-white fs-10">' + e.nickname + '</div><span class="user-status"></span>'
    ...
    e("chat-contacts-list.json", function(e, t) {
        ...
        d.forEach(function(e, t) {
            var s = e.profile ? '<img src="/fg_addon/static/modern/' + e.profile + '" class="img-fluid rounded-circle" alt="">' : '<span class="avatar-title rounded-circle bg-primary fs-10">' + e.nickname + "</span>"
    ...
    new FgEmojiPicker({
        ...
        position: ["top", "right"],
        preFetch: !0,
        dir: "/fg_addon/static/modern/assets/js/pages/plugins/json",
