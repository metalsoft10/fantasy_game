...
const FieldGenerator = {
    ...
    note : (config) =>`
        ...
        <div class="mb-4 " id="${config.id}_div" style="display: none;">
    ...
    `,
    text: (config) => `
        <div class="mb-3" id="${config.id}_div">
...
const sharedModal_cover_Tmpl = ({src = '/medical_base/static/modern/assets/images/small/img-9.jpg',title,with_input}) =>
`
...
`
const sharedModal_member_image_tmpl = ({src = '/medical_base/static/modern/assets/images/users/user-dummy-img.jpg',name='logo'}) =>
`
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="hstack gap-2 justify-content-end">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">${_js_translate('sharedModal_close_btn')}</button>
                        <button type="submit" class="btn btn-success" id="sharedModalSaveBtn">${_js_translate('sharedModal_save_btn')}</button>
