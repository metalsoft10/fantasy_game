...
xhttp.onload = function() {
    ...
    Array.from(e).forEach(function(e) {
        ...
        3 < t.length && (t = t.length - 3,
        a += '<a href="javascript: void(0);" class="avatar-group-item"  data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="' + t + ' More">            <div class="avatar-xxs">            <div class="avatar-title rounded-circle">' + t + "+</div>            </div>        </a>"),
        a += "</div>",
        tasksList.add({
...
,
xhttp.open("GET", "/ajax/patient/list/adv"),
xhttp.send();
...
//     e.relatedTarget.classList.contains("edit-item-btn") ? (document.getElementById("exampleModalLabel").innerHTML = "Edit Task",
//     document.getElementById("showModal").querySelector(".modal-footer").style.display = "block",
//     document.getElementById("add-btn").innerHTML = "Update") : e.relatedTarget.classList.contains("add-btn") ? (document.getElementById("exampleModalLabel").innerHTML = "Add Task",
//     document.getElementById("showModal").querySelector(".modal-footer").style.display = "block",
//     document.getElementById("add-btn").innerHTML = "Add Task") : (document.getElementById("exampleModalLabel").innerHTML = "List Task",
...
var table = document.getElementById("tasksTable")
  ...
  , example = (Array.prototype.slice.call(forms).forEach(function(a) {
    a.addEventListener("submit", function(e) {
        ...
        "" === projectNameField.value || "" === tasksTitleField.value || "" === clientNameField.value || "" === dateDueField.value || "" === priorityField.value || "" === statusField.value || editlist ? "" !== projectNameField.value && "" !== tasksTitleField.value && "" !== clientNameField.value && "" !== dateDueField.value && "" !== priorityField.value && "" !== statusField.value && editlist && (t = tasksList.get({
            id: idField.value
        }),
    ...
    editBtns && Array.from(editBtns).forEach(function(e) {
        e.addEventListener("click", function(e) {
            ...
            Array.from(e).forEach(function(e) {
                ...
                a == itemId && (editlist = !0,
                idField.value = a,
                a = (project = (new DOMParser).parseFromString(e._values.project_name, "text/html")).body.firstElementChild.innerHTML,
                ...
                Array.from(document.querySelectorAll('input[name="assignedTo[]"]')).forEach(function(t) {
                ...
                a = (val = (new DOMParser).parseFromString(e._values.priority, "text/html")).body.firstElementChild.innerHTML,
